...
export const metadata: Metadata = buildPageMetadata({
  title: "Nos véhicules",
  description: `Catalogue DreamEffect — véhicules haut de gamme à louer à ${formatServiceAreaLabel()}. Berlines, SUV et sportives entretenues, disponibilités mises à jour.`,
...
export default async function VehiclesPage() {
  ...
  return (
    <>
      ...
      <PageHero
        title="Nos véhicules"
        description="La flotte DreamEffect, mise à jour automatiquement depuis l'administration."
      />
